...
export declare function parseVueDocuments(vueFiles: VueFiles): {
    ...
    fromEmbeddedLocation: (uri: string, start: vscode.Position, end?: vscode.Position | undefined, filter?: ((data: EmbeddedFileMappingData) => boolean) | undefined, sourceMapFilter?: ((sourceMap: EmbeddedFileSourceMap) => boolean) | undefined) => Generator<{
        uri: string;
        range: {
            start: vscode.Position;
            end: vscode.Position;
