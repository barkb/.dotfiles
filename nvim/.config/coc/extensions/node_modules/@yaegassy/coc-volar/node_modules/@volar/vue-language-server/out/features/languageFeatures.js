...
function register(ts, connection, documents, projects, features, params) {
    ...
    connection.onCompletionResolve((item) => __awaiter(this, void 0, void 0, function* () {
        ...
        return (_g = yield worker(uri, (vueLs) => __awaiter(this, void 0, void 0, function* () {
            var _h;
            return (_h = vueLs.doCompletionResolve(item, newPosition)) !== null && _h !== void 0 ? _h : item;
    ...
    connection.onCodeLensResolve((codeLens) => __awaiter(this, void 0, void 0, function* () {
        var _j, _k;
        const uri = (_j = codeLens.data) === null || _j === void 0 ? void 0 : _j.uri; // TODO
        if (!uri) {
            return codeLens;
        }
        return (_k = yield worker(uri, vueLs => {
            var _a;
            return (_a = vueLs.doCodeLensResolve(codeLens)) !== null && _a !== void 0 ? _a : codeLens;
        })) !== null && _k !== void 0 ? _k : codeLens;
    }));
    ...
    connection.onCodeAction((handler) => __awaiter(this, void 0, void 0, function* () {
        return worker(handler.textDocument.uri, (vueLs) => __awaiter(this, void 0, void 0, function* () {
            var _l;
            const codeActions = (_l = yield vueLs.doCodeActions(handler.textDocument.uri, handler.range, handler.context)) !== null && _l !== void 0 ? _l : [];
    ...
    connection.onCodeActionResolve((codeAction) => __awaiter(this, void 0, void 0, function* () {
        var _m, _o;
        const uri = (_m = codeAction.data) === null || _m === void 0 ? void 0 : _m.uri;
        if (!uri) {
            return codeAction;
        }
        return (_o = yield worker(uri, vueLs => {
            return vueLs.doCodeActionResolve(codeAction);
        })) !== null && _o !== void 0 ? _o : codeAction;
    }));
    ...
    connection.languages.callHierarchy.onPrepare((handler) => __awaiter(this, void 0, void 0, function* () {
        var _p;
        return (_p = yield worker(handler.textDocument.uri, (vueLs) => __awaiter(this, void 0, void 0, function* () {
    ...
    connection.languages.callHierarchy.onIncomingCalls((handler) => __awaiter(this, void 0, void 0, function* () {
        ...
        const uri = (_q = data === null || data === void 0 ? void 0 : data.__uri) !== null && _q !== void 0 ? _q : handler.item.uri;
        return (_r = yield worker(uri, vueLs => {
    ...
    connection.languages.callHierarchy.onOutgoingCalls((handler) => __awaiter(this, void 0, void 0, function* () {
        var _s, _t;
        const data = handler.item.data;
        const uri = (_s = data === null || data === void 0 ? void 0 : data.__uri) !== null && _s !== void 0 ? _s : handler.item.uri;
        return (_t = yield worker(uri, vueLs => {
    ...
    connection.languages.semanticTokens.on((handler, token, _, resultProgress) => __awaiter(this, void 0, void 0, function* () {
        var _u;
        return (_u = yield worker(handler.textDocument.uri, (vueLs) => __awaiter(this, void 0, void 0, function* () {
            var _v;
            const result = (_v = yield (vueLs === null || vueLs === void 0 ? void 0 : vueLs.getSemanticTokens(handler.textDocument.uri, undefined, token, tokens => resultProgress === null || resultProgress === void 0 ? void 0 : resultProgress.report(buildTokens(tokens))))) !== null && _v !== void 0 ? _v : [];
            return buildTokens(result);
        }))) !== null && _u !== void 0 ? _u : buildTokens([]);
    }));
    connection.languages.semanticTokens.onRange((handler, token, _, resultProgress) => __awaiter(this, void 0, void 0, function* () {
        var _w;
        return (_w = yield worker(handler.textDocument.uri, (vueLs) => __awaiter(this, void 0, void 0, function* () {
            var _x;
            const result = (_x = yield (vueLs === null || vueLs === void 0 ? void 0 : vueLs.getSemanticTokens(handler.textDocument.uri, handler.range, token, tokens => resultProgress === null || resultProgress === void 0 ? void 0 : resultProgress.report(buildTokens(tokens))))) !== null && _x !== void 0 ? _x : [];
            return buildTokens(result);
        }))) !== null && _w !== void 0 ? _w : buildTokens([]);
    }));
                            ...
                            if (vscode.TextDocumentEdit.is(change)) {
                                for (const file of handler.files) {
                                    if (change.textDocument.uri === file.oldUri) {
                                        ...
                                        change.textDocument.version = (_z = (_y = (0, utils_1.getDocumentSafely)(documents, file.newUri)) === null || _y === void 0 ? void 0 : _y.version) !== null && _z !== void 0 ? _z : change.textDocument.version;
                                    }
                                }
                            }
                        }
