...
function default_1(options) {
                            ...
                            if (components.has(tokenText) || tokenText.indexOf('.') >= 0) {
                                ...
                                if (components.has(tokenText)) {
                                    ...
                                    for (let i = 0; i < tokenText.length; i++) {
                                        if (tokenText[i] === '.') {
                                            result.push([tokenPosition.line, tokenPosition.character + i, 1, (_e = tokenTypes.get('operator')) !== null && _e !== void 0 ? _e : -1, 0]);
                                        }
                                    }
                                }
                            }
    ...
    function resolveAutoImportItem(item, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const componentName = (0, shared_1.capitalize)((0, shared_1.camelize)(item.label));
